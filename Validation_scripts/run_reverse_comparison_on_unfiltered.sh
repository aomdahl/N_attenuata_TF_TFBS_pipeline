...
#mkdir -p nofilter_MA-MA_comparison_results
...
#mkdir -p nofilter_MA-RNA_comparison_results
...
#mkdir -p nofilter_RNA-RNA_comparison_results
...
#mkdir -p nofilter_RNA-MA_comparison_results
...
python3 ../Toolkit_scripts/HomerTools.py --dirs /mnt/d/AshtonData/MPI_all_data/SummaryFiles_8-17/nofilter_RNA-RNA_comparison_results/ > /mnt/d/AshtonData/MPI_all_data/SummaryFiles_8-17/nofilter_results/RNA-RNA-comparison_summary.tsv &
...
python3 ../Toolkit_scripts/HomerTools.py --dirs /mnt/d/AshtonData/MPI_all_data/SummaryFiles_8-17/nofilter_RNA-MA_comparison_results/ > /mnt/d/AshtonData/MPI_all_data/SummaryFiles_8-17/nofilter_results/RNA-MA-comparison_summary.tsv &
