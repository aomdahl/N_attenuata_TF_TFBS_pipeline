...
tf_reference_match_scores <- read_tsv("./nofilter_complete_results") %>% separate(Split, c("pTF_mod", "refTF"), "_against_") %>% separate(pTF_mod, c("pTF_family", "pTF_i"), "-N")  %>% mutate(pTF = paste0("N", pTF_i))
